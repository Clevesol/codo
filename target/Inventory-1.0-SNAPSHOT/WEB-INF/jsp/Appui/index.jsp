<%-- 
    Document   : index
    Created on : Jan 14, 2017, 10:50:02 PM
...
<head>
  <meta charset="utf-8" />
  <title>${pageContext.request.contextPath} | TEST</title>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/js/calendar/bootstrap_calendar.css" type="text/css" />
  ...
  <section class="vbox">
    <header class="bg-dark dk header navbar navbar-fixed-top-xs">
      <div class="navbar-header aside-md">
        ...
        <a href="#" class="navbar-brand" data-toggle="fullscreen"><!-- <img src="${pageContext.request.contextPath}/resources/images/logo2.png" class="m-r-sm">-->Devot Enterprises</a>
          ...
          <section class="dropdown-menu aside-xl on animated fadeInLeft no-borders lt">
            <div class="wrapper lter m-t-n-xs">
              <a href="#" class="thumb pull-left m-r">
                <img src="${pageContext.request.contextPath}/resources/images/avatar.jpg" class="img-circle">
              </a>
              <div class="clear">
              ...
              <div class="list-group list-group-alt animated fadeInRight">
                <a href="#" class="media list-group-item">
                  <span class="pull-left thumb-sm">
                    <img src="${pageContext.request.contextPath}/resources/images/avatar.jpg" alt="John said" class="img-circle">
                  </span>
                  ...
                  <article id="comment-id-2" class="comment-reply">
                    <article class="comment-item">
                      <a class="pull-left thumb-sm">
                        <img src="${pageContext.request.contextPath}/resources/images/avatar_default.jpg" class="img-circle">
                      </a>
                      <section class="comment-body m-b-lg">
                        <header>
